...
Data_LCD		
				...
				LDR			R4,=0x20000754	;which shows the end of memory of this word "***"
...
Write_stars_LCD										
wait_until_transmit_FIFO_not_full_stars
				LDR			R1,=SSI0_SR		;Status Register
				LDR			R0,[R1]
				AND			R0,#0x02		;TNF flag is obtained.
				CMP			R0,#0x02		
				BNE			wait_until_transmit_FIFO_not_full_stars ;If TNF=0, then transmit buffer is full
				BEQ			send_data_stars		;If TNF=1, then send a new data.
